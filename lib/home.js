        ...
        if (ports.length > 0) {
          ...
          mkdirp(serverDirectory, err => {
            if (!err) {
              ...
              const serverDataDirectorySrc = path.join(dirname, 'defaults', 'data');
              const serverCryptoDirectorySrc = path.join(dirname, 'crypto');
              const serverInstallDirectorySrc = path.join(dirname, 'installed');
              ...
              const serverProcess = child_process.spawn('node', [
                ...
                'dataDirectorySrc=' + serverDataDirectorySrc,
                'cryptoDirectorySrc=' + serverCryptoDirectorySrc,
                'installDirectorySrc=' + serverInstallDirectorySrc,

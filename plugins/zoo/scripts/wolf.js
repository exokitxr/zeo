...
const dyCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 1.1, 0).multiplyScalar(globalScale),
  new THREE.Vector3(7.5, 5, 6).multiplyScalar(globalScale)
);
const splitX = 0;
const splitZ = 0;
const dhCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 5.2, -5.1).multiplyScalar(globalScale),
  new THREE.Vector3(2.7, 3.2, 6).multiplyScalar(globalScale)
);

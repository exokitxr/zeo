...
const dyCutoffBox = new THREE.Box3().setFromCenterAndSize(
  ...
  new THREE.Vector3(3.9, 5.7, 5.5).multiplyScalar(globalScale),
);
const splitX = 0;
const splitZ = 0;
const dhCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 4.5, -3.5).multiplyScalar(globalScale),
  new THREE.Vector3(3.7, 4, 4).multiplyScalar(globalScale)
);

...
const dyCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 0.25, 2.22).multiplyScalar(globalScale),
  new THREE.Vector3(1, 0.62, 5).multiplyScalar(globalScale),
);
const splitX = 0;
const splitZ = 0;
const dhCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 1, -1.4).multiplyScalar(globalScale),
  new THREE.Vector3(3, 1.95, 2).multiplyScalar(globalScale)
);

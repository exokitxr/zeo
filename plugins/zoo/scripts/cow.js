...
const dyCutoffBox = new THREE.Box3().setFromCenterAndSize(
  ...
  new THREE.Vector3(6.8, 12, 14).multiplyScalar(globalScale)
);
const splitX = 0;
const splitZ = 0;
const dhCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 9, -8).multiplyScalar(globalScale),
  new THREE.Vector3(6.8, 7, 12).multiplyScalar(globalScale)
);

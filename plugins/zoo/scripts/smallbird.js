...
const dyCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 0, -0.2).multiplyScalar(globalScale),
  new THREE.Vector3(1.5, 3, 1.4).multiplyScalar(globalScale)
);
const dhCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 2.5, -1.5).multiplyScalar(globalScale),
  new THREE.Vector3(1.5, 1.5, 2).multiplyScalar(globalScale)
);
const splitX = 0;
const splitZ = -10 * globalScale;

...
const dyCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 0.5, 0).multiplyScalar(globalScale),
  new THREE.Vector3(3.75, 5, 10.75).multiplyScalar(globalScale),
);
const splitX = 0;
const splitZ = 0;
const dhCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 5, -3.5).multiplyScalar(globalScale),
  new THREE.Vector3(3, 2.5, 4).multiplyScalar(globalScale)
);

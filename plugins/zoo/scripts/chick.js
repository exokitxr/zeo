...
const dyCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 0, -0.59).multiplyScalar(globalScale),
  new THREE.Vector3(2.5, 3, 1.7).multiplyScalar(globalScale)
);
const splitX = 0;
const splitZ = -100;
const dhCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 4, -2).multiplyScalar(globalScale),
  new THREE.Vector3(2, 3, 2).multiplyScalar(globalScale)
);

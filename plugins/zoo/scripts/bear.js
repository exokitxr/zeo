...
const dyCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 0, -0.3).multiplyScalar(globalScale),
  new THREE.Vector3(15, 12, 11.4).multiplyScalar(globalScale)
);
const splitX = 0;
const splitZ = 0;
const dhCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 9, -10).multiplyScalar(globalScale),
  new THREE.Vector3(7.5, 6, 12).multiplyScalar(globalScale)
);

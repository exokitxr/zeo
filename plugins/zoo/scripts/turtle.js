...
const dyCutoffBox = new THREE.Box3().setFromCenterAndSize(
  ...
  new THREE.Vector3(2.9, 2.4, 3.7).multiplyScalar(globalScale),
);
const splitX = 0;
const splitZ = 0;
const dhCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 2, -2.5).multiplyScalar(globalScale),
  new THREE.Vector3(2, 2, 2).multiplyScalar(globalScale)
);

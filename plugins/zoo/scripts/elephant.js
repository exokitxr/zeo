...
const dyCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 0, -0.5).multiplyScalar(globalScale),
  new THREE.Vector3(14, 27, 20).multiplyScalar(globalScale)
);
const splitX = 0;
const splitZ = 0;
const dhCutoffBoxes = [
  new THREE.Box3().setFromCenterAndSize(
    new THREE.Vector3(0, 20, -14).multiplyScalar(globalScale),
    new THREE.Vector3(20, 12, 10).multiplyScalar(globalScale)
  ),
  new THREE.Box3().setFromCenterAndSize(
    new THREE.Vector3(0, 14, -18).multiplyScalar(globalScale),
    new THREE.Vector3(10, 24, 13).multiplyScalar(globalScale)
  ),
];

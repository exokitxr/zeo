...
const dyCutoffBox = new THREE.Box3().setFromCenterAndSize(
  ...
  new THREE.Vector3(3.15, 3.1, 4.65).multiplyScalar(globalScale),
);
const splitX = 0;
const splitZ = 0;
const dhCutoffBox = new THREE.Box3().setFromCenterAndSize(
  new THREE.Vector3(0, 3.5, -2).multiplyScalar(globalScale),
  new THREE.Vector3(2, 2, 3).multiplyScalar(globalScale)
);

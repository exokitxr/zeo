...
const getPayPageSrc = ({id, hasAvailableBalance, paying, done}) => {
  return `\
      ...
      ${!done ? `\
        ...
        ${hasAvailableBalance ? `\
          <div style="display: flex; margin-bottom: 20px; font-size: 40px; font-weight: 400;">
            ...
            ` : `\
              <div style="display: flex; margin-right: 40px; padding: 10px 20px; border: 3px solid; color: #4CAF50; justify-content: center; align-items: center; box-sizing: border-box;">Paying...</div>
            `}
          </div>
        ` : `\

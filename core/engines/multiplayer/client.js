        ...
        (
          ...
          if (live) {
            ...
            const _addressChange = ({ address, username }) => {
              ...
              connection = new AutoWs(
                _relativeWsUrl(
                  'archae/multiplayerWs?id=' +
                    encodeURIComponent(String(multiplayerApi.getId())) +
                    '&address=' +
          ...
          object.label = label; */
            ...
            const playerStatusUpdate = n => {
              ...
              const remotePlayerSkinMesh = multiplayerApi.getRemotePlayerSkinMesh(
                n
              );
            ...
            const _update = () => {
              ...
              const _updateHmd = () => {
                ...
                if (
                  !localStatus.hmd.position.equals(hmdPosition) ||
                  !localStatus.hmd.rotation.equals(hmdRotation)
                ) {
                ...
                for (let i = 0; i < SIDES.length; i++) {
                  ...
                  if (gamepad) {
                    ...
                    if (
                      ...
                      localStatus.gamepads[side].position.copy(
                        controllerPosition
                      );
                      localStatus.gamepads[side].rotation.copy(
                        controllerRotation
                      );
              ...
              const _updateMetadata = () => {
                if (
                  ...
                  !menuState.position.equals(
                    localStatus.metadata.menu.position
                  ) ||
                  !menuState.rotation.equals(
                    localStatus.metadata.menu.rotation
                  ) ||

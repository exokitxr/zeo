...
export const ATTRIBUTES_WIDTH = 1024;
export const ATTRIBUTES_HEIGHT = ATTRIBUTES_WIDTH / 2;
export const ATTRIBUTES_ASPECT_RATIO = ATTRIBUTES_WIDTH / ATTRIBUTES_HEIGHT;
export const ATTRIBUTES_WORLD_WIDTH = 0.5;
export const ATTRIBUTES_WORLD_HEIGHT = ATTRIBUTES_WORLD_WIDTH / ATTRIBUTES_ASPECT_RATIO;
export const ATTRIBUTES_WORLD_DEPTH = 0.01;

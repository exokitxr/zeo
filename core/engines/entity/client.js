      ...
      if (live) {
        ...
        const _updateNpm = () => {
          ...
          const itemSpecs = tags.getTagMeshes()
            ...
            .map(({item}) => {
              const {id, name, displayName, attributes, instancing, metadata} = item;
        ...
        const entityMesh = (() => {
          ...
          const planeMesh = (() => {
            ...
            const mesh = worldUi.makePage(({
              ...
              return {
                type: 'html',
                src: entityRenderer.getEntityPageSrc({loading, npmInputText, npmInputValue, attributeInputText, attributeInputValue, tagSpecs, numTags, page, focusSpec}),
                x: 0,
                y: 0,
                w: WIDTH,
                h: HEIGHT,

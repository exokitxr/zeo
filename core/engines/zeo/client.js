class Zeo {
  ...
  mount() {
    ...
    return _requestBlocker().then(blocker => {
      if (live) {
        const _resJson = res => {
              ...
              return _startRenderLoop().then(() => {
                if (live) {
                  ...
                  document.body.insertBefore(
                    overlay,
                    renderer.domElement.nextSibling
                  );
                  ...
                  if (supportsWebVR) {
                    ...
                    if (
                      webvr.displayIsPresenting() ||
                      urlRequestPresent === 'hmd'
                    ) {
                      _enterHeadsetVR();
                  ...
                  class ZeoPlayerApi {
                    ...
                    getRemoteHmdMesh(userId) {
                      const remotePlayerMesh = multiplayer.getRemotePlayerMesh(
                        userId
                      );
                  ...
                  class ZeoStckApi {
                    ...
                    makeStaticHeightfieldBody() {
                      return stck.makeStaticHeightfieldBody.apply(
                        stck,
                        arguments
                      );
                    }
                    ...
                    makeStaticEtherfieldBody() {
                      return stck.makeStaticEtherfieldBody.apply(
                        stck,
                        arguments
                      );
                    }
                    ...
                    makeStaticBlockfieldBody() {
                      return stck.makeStaticBlockfieldBody.apply(
                        stck,
                        arguments
                      );
                    }

...
npm start -- hub my newline port=8000 homeUrl=test-home.zeovr.io:8080 hubUrl=test-hub.zeovr.io:8000 cryptoDirectory=crypto-test-hub | tee /tmp/zeo-hub-log.txt &
